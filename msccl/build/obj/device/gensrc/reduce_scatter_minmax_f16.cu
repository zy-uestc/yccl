...
DEFINE_ncclDevFunc(ReduceScatter_MinMax_f16_COLLNET_DIRECT_SIMPLE, ncclFuncReduceScatter, FuncMinMax, half, NCCL_ALGO_COLLNET_DIRECT, NCCL_PROTO_SIMPLE)
...
#endif
DEFINE_ncclDevFunc(ReduceScatter_MinMax_f16_PAT_SIMPLE, ncclFuncReduceScatter, FuncMinMax, half, NCCL_ALGO_PAT, NCCL_PROTO_SIMPLE)
