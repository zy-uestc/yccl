...
DEFINE_ncclDevFunc(ReduceScatter_SumPostDiv_i32_COLLNET_DIRECT_SIMPLE, ncclFuncReduceScatter, FuncSumPostDiv, int32_t, NCCL_ALGO_COLLNET_DIRECT, NCCL_PROTO_SIMPLE)
DEFINE_ncclDevFunc(ReduceScatter_SumPostDiv_i32_PAT_SIMPLE, ncclFuncReduceScatter, FuncSumPostDiv, int32_t, NCCL_ALGO_PAT, NCCL_PROTO_SIMPLE)
