...
DEFINE_ncclDevFunc(ReduceScatter_PreMulSum_u64_COLLNET_DIRECT_SIMPLE, ncclFuncReduceScatter, FuncPreMulSum, uint64_t, NCCL_ALGO_COLLNET_DIRECT, NCCL_PROTO_SIMPLE)
DEFINE_ncclDevFunc(ReduceScatter_PreMulSum_u64_PAT_SIMPLE, ncclFuncReduceScatter, FuncPreMulSum, uint64_t, NCCL_ALGO_PAT, NCCL_PROTO_SIMPLE)
