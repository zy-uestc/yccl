...
ncclResult_t ncclTopoGetXmlFromGpuPCIE(struct ncclXmlNode* pciNode, nvmlDevice_t nvmlDev, struct ncclXml* xml, struct ncclXmlNode** gpuNodeRet) {
...
ncclResult_t ncclTopoFillGpuPCIE(struct ncclXml* xml, const char* busId, struct ncclXmlNode** gpuNode) {
  ...
  NCCLCHECK(ncclTopoGetXmlFromGpuPCIE(node, nvmlDev, xml, gpuNode));
  return ncclSuccess;
}
